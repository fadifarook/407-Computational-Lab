...
time_array = np.arange(
    0, nsamples / sample, 1 / sample
)  # create time array based on t_n = n/f_s
...
plt.plot(
    time_array, channel_0_filtered, label="Filtered", linestyle="--", color="black"
)
...
plt.plot(
    time_array, channel_1_filtered, label="Filtered", linestyle="--", color="black"
)
